...
AddTextBox($row, 'personal_website', 'Site Internet', '', 'url');
AddTextBox($row, 'personal_website_2', '', '', 'url');
AddTextBox($row, 'personal_birthday', 'Naissance', 'Date de naissance', 'date');
...
EndForm('contact_personal', '../controllers/contact_controller.php?type=update');
?>