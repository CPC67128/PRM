...
<?php end_form('Ajouter', '../controllers/contact_controller.php?type=add_relation_to_contact', true); ?>
...
?>
  ...
  <td>
  <span class="ui-icon ui-icon-trash" onclick="var confirmation = confirm('Supprimer ?'); if (confirmation) { dojo.xhrPost({url: '../controllers/contact_controller.php?type=remove_relation_to_contact&contact_id=<?php echo $row["contact_id"]; echo "&"; ?>relation_contact_to_contact_id=<?php echo $ligneRelation["relation_contact_to_contact_id"]; ?>', load: function(data, ioArgs) { RefreshCenterPanel(); }}); }"></span>
  </td>
  </tr>
  <?php
}
